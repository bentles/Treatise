...
\subsection{How Virtual Machine's Work} 
When reading in bytecode, the virtual machine needs some way to know what it is currently reading. This is slightly more complex than just keeping track of how far into the program the VM has read as the program can have instructions that allow the virtual machine to jump between different points in the program. This is how loops and conditional are implemented. The instruction pointer (or IP) is used for this purpose.
