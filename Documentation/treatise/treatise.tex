...
\author{ Douglas Bentley \and Supervisor: Kevin Naud\'{e} }
...
which operation the VM must perform.

Bits 6 through 13 are always used to index the first argument. The
remaining 18 bits encode additional operands which appear in any of
