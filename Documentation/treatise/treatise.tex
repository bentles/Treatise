...
reviewed. With this background in place, a discussion of the design
decisions made for the proposed solution can follow.
...
machine. This is beneficial because, as was discussed in section
...
them. Many of these type checks can be eliminated with type-mapping. Another
...
Dispatch VM, an issue was discussed in section
