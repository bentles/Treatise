...
described in the previous chapter. First, a discussion of all results
for each benchmark is discussed, and then an overview of the results
across all benchmarks follows.
