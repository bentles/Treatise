...
%TODO: ACTUALLY EXPLAIN THIS AND DONT FORGET!!
...
\begin{figure}[!htb]
	\centering
	\begin{tikzpicture}
	\tikzstyle{every node}=[draw,shape=rectangle,anchor=west,minimum width=50pt,minimum height=18pt];
	\node (v0) at (0,-2) {$add$};
