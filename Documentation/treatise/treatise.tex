...
Since writing 1295 instructions by hand is not feasible, code for all three VMs was generated from templates. The code generator was written from scratch in JavaScript. The code generator accepts an array of specially formatted JavaScript objects.
...
The symbol \verb|/*<state:0>*/| is exlusive to the Operand-Type Disptach VM and is only replaced when generating code for it, otherwise it is replaced with an empty string.   
